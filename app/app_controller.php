...
//echo $this->here;
        if (($this->here == "/workspace/doctorsmobile/" ||$this->here == "/doctorsmobile/" ||$this->here == "/") && !isset($this->params['admin'])) {
            $this->layout = 'default';
        } elseif (($this->here == "/workspace/doctorsmobile/eng"||$this->here == "/doctorsmobile/eng"  ||$this->here == "/eng")&& !isset($this->params['admin'])) {
            $this->layout = 'default';
			   // print_r($this->here);exit;
        } elseif (($this->here == "/workspace/doctorsmobile/eng/" ||$this->here == "/doctorsmobile/eng/" ||$this->here == "/eng/")&& !isset($this->params['admin'])) {
            $this->layout = 'default';
        } elseif (($this->here == "/workspace/doctorsmobile/ara" ||$this->here == "/doctorsmobile/ara" ||$this->here == "/ara")&& !isset($this->params['admin'])) {
            $this->layout = 'default';
        } elseif (($this->here == "/workspace/doctorsmobile/ara/" ||$this->here == "/doctorsmobile/ara/" ||$this->here == "/ara/")&& !isset($this->params['admin'])) {
            $this->layout = 'default';
        } 
            ...
            if (!isset($this->params['admin'])) {
            	/*if (isset($this->params['locale'])&& $this->params['locale'] =='eng') {
			      $this->layout = 'inner_en';
		        }else{
		            $this->layout = 'inner';	
		        }*/
                $this->layout = 'inner';
