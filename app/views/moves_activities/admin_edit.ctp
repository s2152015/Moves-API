...
<?php echo $this->Form->create('MovesActivity');?>
	<fieldset>
		<legend><?php __('Admin Edit Moves Activity'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MovesActivity.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MovesActivity.id'))); ?></li>
