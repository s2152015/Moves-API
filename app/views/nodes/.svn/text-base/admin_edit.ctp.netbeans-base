...
<div class="nodes form">
	...
	<?php echo $this->Form->create('Node', array('url' => array('action' => 'edit'), 'type' => 'file'));?>
		<fieldset>
			<div class="tabs">
				<ul>
					...
					<li><a href="#node-publishing"><span><?php __('Publishing'); ?></span></a></li>
                                        <li><a href="#node-uploadmainimage"><span><?php __('Upload Main Image'); ?></span></a></li>
				...
				?>
                              ...
                              <div id="node-uploadmainimage">
                                     <?php if ($this->data['Node']['img_file_name']) echo $upload->image($this->data, 'Node.img', array('style' => 'thumb2'),array("alt" => $this->data['Node']['title']));
                                     ?>
				<?php
                                //echo $this->Form->input('img');
                                //print_r( );
                                
					 echo $this->Form->input('Node.img', array('label' => __('Upload', true), 'type' => 'file'));
				?>
				</div>
				<?php echo $this->Layout->adminTabs(); ?>
                            <div class="clear">&nbsp;</div>
